...
//
// Defaults are tuned for Flight Tracker's documented topology:
...
//   - *.local                        (mDNS, e.g. flighttracker.local)
//
// Operators that expose Flight Tracker on a public hostname can add it via the
